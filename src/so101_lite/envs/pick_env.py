...
from so101_lite.objects import CubeObject, MeshObject, SceneObject, YCBObject
from so101_lite.envs.base_env import SCENE_OPTION_XML, SO101NexusMuJoCoBaseEnv
from so101_lite.envs.spawn_utils import (
...
class PickEnv(SO101NexusMuJoCoBaseEnv):
    ...
    def _get_component_data(self, component: object) -> np.ndarray:
        from so101_lite.observations import ObjectOffset as _ObjectOffset
        from so101_lite.observations import ObjectPose as _ObjectPose
